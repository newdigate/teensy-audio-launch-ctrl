...
void setup() {
  ...
  */
  ...
  /*
    ...
    Bitmap, BitmapWidth, BitmapHeight);
  */
  OptionOption1 = OptionMenu.add565("Note", 0, 0, 128, 1, 0, NULL, _bmp_allArray[0], 16, 16);
  /*
  OptionOption2 = OptionMenu.add565("Ch",   0, 0,  15, 1, 2, NULL,  _bmp_allArray[1], 16, 16);
  OptionOption3 = OptionMenu.add565("Sample", 2, 0, sizeof(ReadoutItems) / sizeof(ReadoutItems[0]), 1, 0, ReadoutItems,  _bmp_allArray[2], 16, 16);
  OptionOption4 = OptionMenu.add565("Tune", 0, 0, 20 , 1, 0, NULL,  _bmp_allArray[3], 16, 16);
  OptionOption5 = OptionMenu.add565("Trigger", AlarmVal, 0, sizeof(OffOnItems) / sizeof(OffOnItems[0]), 1, 0, OffOnItems,  _bmp_allArray[4], 16, 16);
  OptionOption6 = OptionMenu.add565("Loop", 0, 0, sizeof(PrecisionItems) / sizeof(PrecisionItems[0]), 1, 0, PrecisionItems,  _bmp_allArray[5], 16, 16);
  */
  ...
  OptionMenu.setItemValue(OptionOption1, 0);
